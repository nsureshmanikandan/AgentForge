...
class MultiAgentOrchestrator:
    """Manager agent coordinates multiple worker agents sequentially."""
    ...
    async def run(self, user_input: str) -> dict:
        ...
        manager_prompt = (
            f"You are a manager agent. Given the user request, decide which worker agents "
            f"to invoke (from: {worker_names}) and in what order. "
            f"Return ONLY a JSON array of worker names, e.g. [\"WorkerA\"]. "
