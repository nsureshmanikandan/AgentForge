...
async def test_generate_returns_agent_config():
    ...
    mock_response = '{"name":"HR Bot","description":"Handles HR queries","system_prompt":"You are an HR assistant.","model":settings.azure_openai_deployment_gpt4o,"tools":["email"],"guardrails":{"pii":true,"hallucination":true}}'
