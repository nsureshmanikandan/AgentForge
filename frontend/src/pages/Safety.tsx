  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex gap-3 bg-amber-50 border border-amber-100 rounded-xl px-5 py-4 mb-6">
        ...
        <div>
          <p className="text-sm font-medium text-amber-800">Partially enforced</p>
          <p className="text-xs text-amber-700 mt-0.5">
            PII Detection and Hallucination Check now act as an org-wide switch — disabling either here blocks every agent from using it, even if that agent's own Agent Studio config has it turned on. The other rules below are still saved but not yet consulted by live agent runs.
          </p>
        </div>
      </div>
